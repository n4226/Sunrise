...
namespace sunrise::gfx {
	...
	GPUStageRenderPass::GPUStageRenderPass(vk::Device device, VkFormat albedoFormat, VkFormat normalFormat, VkFormat aoFormat, VkFormat swapChainImageFormat, VkFormat depthBufferFormat)
	...
	GPUStageRenderPass::~GPUStageRenderPass()
	{
